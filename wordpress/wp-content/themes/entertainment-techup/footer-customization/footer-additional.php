...
if( ! function_exists( 'techup_footer_start' ) ):
	function techup_footer_start(){
		$footer_sticky = get_theme_mod( 'techup_footer_sticky_opt', true ); ?>
		    ...
		    <footer class="footer footer-one" id="foot-wdgt" style="background-image:url(<?php echo esc_attr(get_stylesheet_directory_uri() . '/assets/images/img.jpg'); ?>)">
		...
		<div class="foot-bottom">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <?php bloginfo( 'name' ); ?> 						
						<a href="<?php echo esc_url( __( 'https://wordpress.org/', 'entertainment-techup' ) ); ?>" class="imprint">
						<?php
							/* translators: %s: WordPress */
						printf( __( 'Proudly Powered By %s', 'entertainment-techup' ), 'WordPress' );
						?>
                    </div>
                </div>
            </div>
